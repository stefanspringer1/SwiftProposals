...
As for the “non-obvious way” of introducing non-optional sequences, this might be true to some degree, but the proposed solution is still quite explicit in comparison to allowing optional sequences in for-in loops without making this explicit (see one of the alternatives listed below).
